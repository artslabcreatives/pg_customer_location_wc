<?php
/**
 * PGs by Customer Location from Artslab Creatives for WooCommerce - Functions - Admin
 *
 * @version 1.4.0
 * @since   1.0.0
 *
...
if ( ! function_exists( 'alc_pg_by_location_wc_get_states' ) ) {
	/**
	 * alc_pg_by_location_wc_get_states.
	 *
	 * @version 1.0.0
	 * @since   1.0.0
	 */
	function alc_pg_by_location_wc_get_states() {
...
if ( ! function_exists( 'alc_pg_by_location_wc_get_countries' ) ) {
	/**
	 * alc_pg_by_location_wc_get_countries.
	 *
	 * @version 1.0.0
	 * @since   1.0.0
	 *
	 ...
	 */
	function alc_pg_by_location_wc_get_countries() {
		return array(
