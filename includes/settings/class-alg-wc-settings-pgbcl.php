<?php
/**
 * PGs by Customer Location from Artslab Creatives for WooCommerce - Settings
 *
 * @version 1.5.0
 * @since   1.0.0
 *
...
class Alg_WC_Settings_Payment_Gateways_by_Customer_Location extends WC_Settings_Page {
	...
	function __construct() {
		$this->id    = 'alc_pg_by_location_wc';
		$this->label = __( 'PGs by Customer Location from Artslab Creatives', 'payment-gateways-by-customer-location-for-woocommerce' );
		parent::__construct();
		// Sections
